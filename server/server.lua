...
AddEventHandler("id_playtimereward:giveReward", function()
    local xPlayer = ESX.GetPlayerFromId(source)
    ...
    local plate = math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9)
    local mods =
