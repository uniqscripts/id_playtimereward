...
GlobalState.MoneyReward = math.random(5000, 10000) -- amount of money that will be given as a reward (only if GlobalState.Reward is "money")
GlobalState.ItemReward = 'bread' -- item that will be given as a reward (only if GlobalState.Reward is "item")
GlobalState.ItemRewardCount = math.random(1, 5) -- count of items that will be given as a reward (only if GlobalState.Reward is "item")
